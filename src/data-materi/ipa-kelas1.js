...
const ipa1bab1 = {
  ...
  page: `
    <div class="container-materi-bab">
      <h2 class="title-materi-bab">Klasifikasi Benda</h2>
      <h3 class="title-smb1">A. Apa Ciri-ciri dari Benda-benda di Lingkungan Sekitar</h3>
      <p class="text-smb">Di lingkungan sekitar terdapat banyak sekali benda. Mobil, motor, sepeda, sepatu, pensil, udara, papan tulis merupakan bentuk benda. Setiap jenis benda mempunyai sifat atau ciri yang membedakannya dari jenis benda lain.</p>

      <h3 class="title-smb1">B.	Bagaimana Mengklasifikasi Makhluk Hidup</h3>
      <p class="text-smb">Manusia, hewan, dan tumbuhan merupakan kelompok makhluk hidup. Makhluk hidup dan benda tak hidup atau benda mati dibedakan dengan adanya gejala kehidupan. Makhluk hidup menunjukkan adanya ciri-ciri atau gejala-gejala kehidupan, sedangkan benda mati tidak menunjukkan gejala-gejala kehidupan.</p>
      <p class="text-smb">Secara umum, ciri-ciri yang ditemukan pada makhluk hidup adalah bernapas, bergerak, makan dan minum, tumbuh dan berkembang, berkembang biak, mengeluarkan zat sisa, peka terhadap rangsang, dan menyesuaikan diri terhadap lingkungan.</p>
      <div class="box-sub">
      <h4 class="title-smb2">1.	Bernapas </h4>
      <p class="text-smb">Setiap saat kamu bernapas, yaitu menghirup udara yang diantaranya mengandung oksigen (O2) dan mengeluarkan udara dengan kandungan karbondioksida (CO2) lebih besar dari yang dihirup. </p>

      <h4 class="title-smb2">2.	Memerlukan Makanan dan Minuman </h4>
      <p class="text-smb">Untuk beraktivitas, setiap makhluk hidup memerlukan energi, untuk memperoleh energi, makhluk hidup memerlukan makanan dan minuman.</p>

      <h4 class="title-smb2">3.	Bernapas </h4>
      <p class="text-smb">Berjalan, berlari, berenang, dan menggerakkan tangan. Itu merupakan ciri bergerak. Tubuhmu dapat melakukan aktivitas karena memiliki sistem gerak. Sistem gerak terdiri atas tulang, sendi, dan otot. Ketiganya bekerja sama membentuk sistem gerak.</p>

      <h4 class="title-smb2">4.	Tumbuh dan Berkembang  </h4>
      <p class="text-smb">Tubuh semakin tinggi dan berat badan semakin bertambah dibandingkan waktu masih kecil.  Hewan juga mengalami hal yang sama. Kupu-kupu bertelur, telur tersebut kemudian menetas menjadi ulat, lalu menjadi kepompong, kepompong berubah bentuk menjadi kupu-kupu muda, dan akhirnya berkembang menjadi kupu-kupu dewasa.</p>

      <h4 class="title-smb2">5.	Berkembang Biak (Reproduksi) </h4>
      <p class="text-smb">Kemampuan makhluk hidup untuk memperoleh keturunan disebut berkembang biak (reproduksi). Berkembang biak bertujuan untuk melestarikan keturunan agar tidak punah. Sebagai contoh kamu lahir dari ayah dan ibu, ayah dan ibumu masing-masing juga mempunyai orang tua yang kamu panggil kakek dan nenek, dan seterusnya.</p>

      <h4 class="title-smb2">6.	Peka terhadap Rangsang </h4>
      <p class="text-smb">Manusia mempunyai kemampuan untuk memberikan tanggapan terhadap rangsangan yang diterima, kemampuan menanggapi rangsangan disebut iritabilitas. Contohnya adalah reaksi jika tiba-tiba ada sorot lampu yang sangat terang dan tentu secara spontan kamu akan segera menutup kelopak mata.</p>

      <h4 class="title-smb2">7.	Menyesuaikan diri terhadap Lingkungan  </h4>
      <p class="text-smb">Kemampuan makhluk hidup untuk menyesuaikan diri dengan lingkungan disebut adaptasi. Contoh: tumbuhan yang hidup di tempat kering memiliki daun yang sempit dan tebal, sedangkan tumbuhan yang hidup di tempat lembab memiliki daun lebar dan tipis</p>
      </div>
      
      <h3 class="title-smb1">C.	Bagaimana Mengklasifikasi Materi</h3>
      <p class="text-smb">Alam semesta tersusun atas berjuta-juta materi yang menempatinya. Ada planet, jutaan bintang, udara, lautan, dan banyak lagi materi lainnya seperti unsur air, udara, tanah, api.</p>
      <div class="box-sub">
      ...
      <h5 class="title-smb3">c.	Campuran</h5>
      <p class="text-smb">Campuran adalah suatu materi yang terdiri dari dua zat lebih dan masih mempunyai sifat zat asalnya. Campuran dibagi menjadi 2 (dua) yaitu campuran homogen dan heterogen.</p>
      <div class="box-sub1">
          <h5 class="title-smb3">1)	Campuran Homogen</h5>
          <p class="text-smb">Campuran homogen adalah campuran yang tidak dapat dibedakan zatzat yang tercampur di dalamnya. Contoh campuran homogen adalah larutan. Pada dasarnya, larutan kelompokkan menjadi larutan yang bersifat asam, basa, atau garam.</p><br>
          <p class="text-smb">a)	Asam<br>Berikut ciri atau tanda dari larutan asam<br>•	Rasanya asam (tidak boleh dirasa kecuali dalam makanan) <br>•	Dapat menimbulkan korosif <br>•	Mengubah kertas lakmus biru menjadi merah</p><br>
          <p class="text-smb">b)	Basa<br>Dalam penggunaan sehari-hari, pada umumnya basa dicampur dengan zat lain. Berikut merupakan sifat basa:<br>•	Terasa licin di kulit dan berasa agak pahit <br>•	Mengubah kertas lakmus merah menjadi </p>
          <p class="text-smb">Dalam kehidupan sehari-hari, larutan asam sering direaksikan dengan larutan basa yang menghasilkan senyawa netral atau dikenal dengan reaksi netralisasi. Larutan basa akan menetralkan larutan asam dan yang membentuk air (H2 O). Selain membentuk H2 O, pada reaksi netralisasi dihasilkan juga garam. </p><br>
          <p class="text-smb">c)	Garam<br>Jenis senyawa garam yang paling kita kenal adalah garam dapur atau nama senyawa kimianya natrium klorida (NaCl). Senyawa garam dapat terbentuk salah satunya melalui  reaksi asam dan basa atau reaksi netralisasi. Pada reaksi netralisasi tersebut, dihasilkan garam dan air.</p>

          <h5 class="title-smb3">2)	Campuran Heterogen</h5>
          <p class="text-smb">Campuran heterogen terjadi karena zat yang tidak dapat bercampur satu dengan lain secara sempurna sehingga dapat dikenali zat penyusunnya. Dengan demikian, pada campuran heterogen, seluruh bagiannya tidak memiliki komposisi yang sama (tidak serba sama).</p>
      </div>
    </div>
  `,
}
...
const ipa1bab4 = {
  ...
  page: `
  <div class="container-materi-bab">
    <h2 class="title-materi-bab">Sistem Organisasi Kehidupan</h2>

    <h3 class="title-smb1">A.	Sel sebagai Unit Struktural dan Fungsional Kehidupan</h3>
    <p class="text-smb">
      Sel merupakan unit terkecil kehidupan. Sel mampu melakukan regulasi terhadap dirinya sendiri, memeroses energi, 
      tumbuh dan berkembang, tanggap terhadap lingkungan, serta melakukan reproduksi untuk melestarikan keturunannya.
    </p>
    <p class="text-smb">
      Setiap organisme tersusun atas salah satu dari dua jenis sel yang secara struktural berbeda: sel prokariotik dan sel eukariotik. 
      ...
      Sel prokariotik berasal dari bahasa Yunani Prokaryote, pro berarti “sebelum” dan karyon berarti nukleus. 
      Sel prokariotik memiliki nukleus/inti sel tetapi inti sel tersebut tidak diselubungi membran inti. 
      Sel Eukariotik (Yunani, eu berarti “sejati/ sebenarnya”) merupakan sel yang memiliki inti sel dan inti sel tersebut dibungkus oleh 
      membran inti.
    </p>
    ...
    <p class="text-smb">
      ...
      sel eukariota karena tidak mempunyai organel yang terbungkus membran. Batas sel ialah membran plasma. Di luar membran plasma 
      terdapat dinding sel yang cukup kaku dan seringkali berupa kapsul luar, yang biasanya mirip jeli. Sebagian bakteri memiliki flagela 
      (organel pergerakan), pili (struktur pelekatan), atau keduanya yang menonjol dari permukaannya.
    </p>

    <h3 class="title-smb1">B.	Jaringan</h3>
    <p class="text-smb">Jaringan adalah kelompok sel-sel yang mempunyai fungsi dan bentuk yang sama. Setiap sel suatu organisme memiliki 
      ukuran yang bervariasi, sebagian besar sel berdiameter antara 1 sampai 100 µm sehingga hanya dapat dilihat dengan menggunakan 
      mikroskop. Ukuran sel mencerminkan fungsi yang dilakukan sel bersangkutan.
    </p>
    <p class="text-smb"> Semua fungsi hidup organisme bersel satu dilakukan oleh sel tunggal itu sendiri. Pada organisme bersel banyak, 
      seringkali sel tidak dapat bekerja sendiri. Setiap sel bergantung kepada sel yang lain. Kerja sama dan interaksi di antara sel ini 
      menyebabkan organisme dapat mempertahankan hidupnya.          
    </p>
    <p class="text-smb"> Tumbuhan mempunyai bermacam-macam jaringan. Jaringan pembuluh kayu (xilem) berfungsi mengangkut air dan 
      unsur hara dari akar ke daun, sedangkan jaringan pembuluh tapis (floem) mengangkut zat makanan dari daun ke seluruh tubuh tumbuhan. 
      Hewan maupun manusia mempunyai bermacam-macam jaringan juga. Ada jaringan epitel, jaringan otot, jaringan tulang rawan, 
      jaringan saraf, dan sebagainya.          
    </p>

    <h3 class="title-smb1">C.	Organ</h3>
    <p class="text-smb">Organ merupakan Kumpulan dari beberapa macam jaringan yang berbeda dan membentuk satu kesatuan untuk melakukan 
      fungsi tertentu.
    </p>

    <h3 class="title-smb1">D.	Sistem Organ dan Organisme</h3>
    <p class="text-smb">Sistem organ adalah beberapa organ yang bekerja sama untuk melakukan fungsi kerja tertentu. Dalam melaksanakan 
      kerja sama ini, setiap organ tidak bekerja sendirisendiri, melainkan organ-organ saling bergantung dan saling memengaruhi satu sama 
      lainnya. Tanpa ada kerja sama dengan organ lain, proses dalam tubuh tidak akan terjadi. Berikut merupakan sistem organ pada manusia:
    </p>
    
      <table class="sistem-organ">
        <tr>
          <th class="nomor">No</th>
          <th>Sistem</th>
          <th class="gambarSistem">Gambar</th>
          <th>Organ</th>
          <th class="fungsi">Fungsi</th>
        </tr>
        <tr>
            <td class="nomor">1</td>
            <td class="sistem">Sistem pencernaan </td>
            <td class="gambarSistem"> <img class="gambar" src="./images/kelassatu/IPA/4.sistemPencernaan.jpg" alt="Sistem pencernaan"></td>
            <td class="organ">Mulut (lidah, gigi), faring, esofagus, lambung, usus halus, usus besar, hati, rektum, pankreas, dan anus</td>
            <td class="fungsi">Mencerna makanan, mengabsorsi molekul-molekul makanan yang sudah disederhanakan</td>
        </tr>
        <tr>
          <td class="nomor">2</td>
          <td class="sistem">Sistem pernapasan</td>
          <td class="gambarSistem"> <img class="gambar" src="./images/kelassatu/IPA/4.sistemPernapasan.png" alt="Sistem pernapasan"></td>
          <td class="organ">Hidung, faring, epiglotis, laring, trakea, bronkus, paru-paru, diafragma</td>
          <td class="fungsi">Pertukaran gas (oksigen dan karbon dioksida)</td>
        </tr>
        <tr>
          <td class="nomor">3</td>
          <td class="sistem">Sistem gerak (rangka)</td>
          <td class="gambarSistem"> <img class="gambar" src="./images/kelassatu/IPA/4.sistemGerak.png" alt="Sistem gerak"></td>
          <td class="organ">Tulang</td>
          <td class="fungsi">Menyokong dan melindungi organ dalam</td>
        </tr>
        <tr>
          <td class="nomor">4</td>
          <td class="sistem">Otot</td>
          <td class="gambarSistem"> <img class="gambar" src="./images/kelassatu/IPA/4.otot.png" alt="Otot"></td>
          <td class="organ">Otot</td>
          <td class="fungsi">Menggerakkan tulang</td>
        </tr>
        <tr>
          <td class="nomor">5</td>
          <td class="sistem">Sistem transportasi/ sirkulasi/ peredaran darah</td>
          <td class="gambarSistem"> <img class="gambar" src="./images/kelassatu/IPA/4.sistemTransportasi.jpg"alt="Sistem transportasi"></td>
          <td class="organ">Jantung, arteri, vena, kapiler</td>
          <td class="fungsi">Mengangkut oksigen dan sari makanan ke seluruh sel tubuh, dan mengandung zat hasil metabolisme yang tidak berguna keluar dari sel tubuh, serta melindungi tubuh dari penyakit</td>
        </tr>
        <tr>
          <td class="nomor">6</td>
          <td class="sistem">Sistem ekskresi</td>
          <td class="gambarSistem"> <img class="gambar" src="./images/kelassatu/IPA/4.sistemEkskresi.jpg" alt="Sistem ekskresi"></td>
          <td class="organ">Paru-paru, ginjal, kulit, dan hati</td>
          <td class="fungsi">Mengeluarkan sisa metabolisme yang tidak terpakai dari dalam tubuh dan menjaga keseimbangan sel dengan lingkungan</td>
        </tr>
        <tr>
          <td class="nomor">7</td>
          <td class="sistem">Sistem reproduksi</td>
          <td class="gambarSistem"> <img class="gambar" src="./images/kelassatu/IPA/4.sistemReproduksi.png" alt="Sistem reproduksi"></td>
          <td class="organ">Testes, ovarium</td>
          <td class="fungsi">Perkembangbiakan</td>
        </tr>
      </table>  
  </div>
  `,
...
module.exports = { ipa1bab1, ipa1bab2, ipa1bab3, ipa1bab4};